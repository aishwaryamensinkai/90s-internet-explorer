      ...
      <PixelBorder>
        <div className="bg-gray-100 p-4">
          <div className="flex items-center mb-4">
            ...
            />
            <p className="text-lg">
              Internet Explorer: Your Gateway to the World Wide Web
            </p>
          </div>
          <p className="mb-4">
            Internet Explorer (IE) is a series of graphical web browsers
          ...
          <table className="w-full border-collapse border border-gray-400 mb-4">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-gray-400 p-2">
                  Dynamic HTML, Active Desktop Integration
                </td>
              </tr>
              <tr>
                <td className="border border-gray-400 p-2">
                ...
                <td className="border border-gray-400 p-2">
                  Improved CSS support, XMLHttpRequest
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="bg-gray-100 p-4">
          {/* Existing content */}
          <h2 className="text-xl font-bold mt-4 mb-2">Easter Eggs</h2>
          <p>
            Our 90s Internet Explorer recreation includes some hidden features:
          </p>
          <ul className="list-disc list-inside space-y-2 mb-4">
            <li>
              Keep an eye out for a helpful assistant who might pop up from time
              to time!
            </li>
            <li>
              Try entering the famous Konami code to unlock a secret game. Can
              you find it?
            </li>
          </ul>
          <p className="text-sm italic">
            Hint: The Konami code is a sequence of button presses: ↑↑↓↓←→←→BA
          </p>
        </div>
      </PixelBorder>
    </div>
